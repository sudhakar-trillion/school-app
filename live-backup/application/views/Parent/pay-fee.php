                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-6">
											<select class="form-control ClassName payfeeclass" name="ClassName" id="ClassName">
                                              ...
                                              <option value="<?PHP echo $this->session->userdata('CLASS')?>" selected ><?PHP echo $this->session->userdata('ClassName')?> </option>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-6">
											<select class="form-control" name="sections" id="sections">
                                             ...
                                             <option value="<?PHP echo $this->session->userdata('SectionId')?>" ><?PHP echo $this->session->userdata('ClassSection')?></option>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-6">
											<select class="form-control" name="Rollno" id="Rollno">
                              				<option value="<?PHP echo $this->session->userdata('StudentRoll')?>"  ><?PHP echo $this->session->userdata('Student') ?></option>
                                            </select>
                                          </div>
									...
									?>
                                      ...
                                      <div class="form-group notificationdiv">
                                        	 ...
                                        	 <div class="col-lg-6"> 
												...
												<input type="text" class="form-control" name="MonthlyFee" id="MonthlyPayFee" value="<?PHP echo @$MonthlyFee;?>" />
                                              </div>
