                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li id="alert_notificatoin_bar" class="dropdown" title="Fee details">
                        ...
                        <ul class="dropdown-menu extended notification">
                            ...
                            <li>
                               <!-- <a href="<?PHP echo base_url('view-fees-details')?>">
                                    <span class="label label-warning"><i class="fa fa-eye"></i></span>  
                                    view transport details
                                   transportdetails
                                </a>-->
                                
                                <a href="<?PHP echo base_url('view-fees-details')?>" class="">
                                    <span class="label label-warning"><i class="fa fa-eye"></i></span>  
                                    view fees details
                    ...
                    <li id="alert_notificatoin_bar" class="dropdown" title="Manage Transportation">
                        ...
                        <ul class="dropdown-menu extended notification">
                            <div class="notify-arrow notify-arrow-blue"></div>
                            <li>
                                <p class="blue">Transportation Details</p>
                            </li>
                            
                            
                            <li>
                               <!-- <a href="<?PHP echo base_url('view-transport-details')?>">
                                    <span class="label label-warning"><i class="fa fa-eye"></i></span>  
                                    view transport details
                                   transportdetails
                                </a>-->
                                
                                <a href="javascript:void(0)" class="view-trasp">
                                    <span class="label label-warning"><i class="fa fa-eye"></i></span>  
                                    view transport details
