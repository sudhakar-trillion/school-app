...
//			echo $root_dir; 
	...
	public function striptags($posted_data)
		...
		if( strpos($requested_from, 'localhost') !== false || strpos($requested_from, 'http://192.168.0.5') !== false || strpos($requested_from, 'adiakshara.in') !== false)
...
if(strpos($requested_from, 'adiakshara.in') !== false)
{
