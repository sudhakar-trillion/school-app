...
if( $_SERVER['HTTP_HOST'] == "localhost" || $_SERVER['HTTP_HOST'] == "192.168.0.3" )
{
	$db['default'] = array(
		'dsn'	=> '',
		'hostname' => 'localhost',
...
else
{
		...
		'dsn'	=> '',
		'hostname' => 'localhost',
	//	'username' => 'vsksamsu_sclmgmt',
		//'password' => '#qkH=z!{z!tM',
		//'database' => 'vsksamsu_tsm',
/*		
		'username' => 'adiaksha_sclmgmt',
		'password' => '#qkH=z!{z!tM',
		'database' => 'adiaksha_schoolapp',
*/
		'username' => 'vsksamsu_school',
		'password' => 'Kr!$61rn>imuX7',
		'database' => 'vsksamsu_schoolaap',
