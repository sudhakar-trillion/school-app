...
?>	                                 
<div class="pre_div"><a href="<?PHP echo base_url('parent-view-holidays')."/".$yr."/".$prevmont?>"><i class="fa fa-arrow-left" aria-hidden="true"></i></a></div>   
<?PHP
}
else
{
...
{
?>
<div class="next_div"><a href="<?PHP echo base_url('parent-view-holidays')."/".$yr."/".$nxtmont?>"><i class="fa fa-arrow-right" aria-hidden="true"></i></a></div> <?PHP
}
else
{
	?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <!-- 	<input type="text" class="form-control cel_date"  placeholder=""/>-->
            <span class="cel_date"></span>
