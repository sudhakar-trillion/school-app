...
?>	                                 
<div class="pre_div"><a href="<?PHP echo base_url('view-events')."/".$yr."/".$prevmont?>"><i class="fa fa-arrow-left" aria-hidden="true"></i></a></div>   
<?PHP
}
else
{
...
{
?>
<div class="next_div"><a href="<?PHP echo base_url('view-events')."/".$yr."/".$nxtmont?>"><i class="fa fa-arrow-right" aria-hidden="true"></i></a></div> <?PHP
}
else
{
	?>
