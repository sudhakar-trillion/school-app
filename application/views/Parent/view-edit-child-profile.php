                             ...
                             <ul class="nav nav-tabs">
                              ...
                              <div class="tab-content">
                                  ...
                                  <form class="form-validate form-horizontal " id="child_profile" method="post" action="" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group ">
                                          <label for="BloodGroup" class="control-label col-lg-3">Date Of Birth<span class="required">*</span></label>
                                          <div class="col-lg-9">
                                          <input type="hidden" id="selectedDOB" value="<?PHP echo $dob;?>" />
											<input type="text" name="DOB" id="DOB" class="BloodGroup form-control"  value=""  placeholder="Date Of Birth" />
                                             <div class="col-lg-2 err-msg"><span class="DOB_Error"></span> </div>
                                          </div>
