...
?>	                                 
<div class="pre_div"><a href="<?PHP echo base_url('view-exam-schedules')."/".$yr."/".$prevmont?>"><i class="fa fa-arrow-left" aria-hidden="true"></i></a></div>   
<?PHP
}
else
{
...
{
?>
<div class="next_div"><a href="<?PHP echo base_url('view-exam-schedules')."/".$yr."/".$nxtmont?>"><i class="fa fa-arrow-right" aria-hidden="true"></i></a></div> <?PHP
}
else
{
	?>
...
<div id="editExamSchedule" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <a class="previousDated" ><i class="fa fa-arrow-left modal-back" aria-hidden="true"></i></a>  <h4 class="modal-title back">View exam schedule</h4>
      </div>
        ...
        <div class="col-md-12 event_da" style="position:relative">
            ...
            <div class="col-md-5"> <input type="text" class="form-control cel_date examdate ExamSchedule" id="examdate" placeholder="" />  </div>
             ...
             <div class="col-md-12 event_da">
                ...
                <select class="form-control ClassName" name="ClassName" id="ClassName" disabled="disabled" style="-webkit-appearance: none;">
              ...
              <div class="col-md-12 event_da">
		        <label>Section</label>
                <select class="form-control ClassSection" name="sections" id="sections" disabled="disabled" style="-webkit-appearance: none;">
              ...
              <div class="col-md-12 event_da">
		        <label>Subject</label>
                <select class="form-control Subjects" name="subject" id="subject" disabled="disabled" style="-webkit-appearance: none;">
              ...
              <div class="col-md-12 event_da">
               ...
               <select class="form-control ExamName" name="ExamName" id="ExamName" disabled="disabled" style="-webkit-appearance: none;">
