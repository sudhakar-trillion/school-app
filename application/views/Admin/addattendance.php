...
<!-- Modal -->
<div id="presentAbsModal"  class="modal fade disableclick" role="dialog" data-backdrop="static" style="cursor:move">
...
<div id="absenteeslist"  class="modal fade disableclick" role="dialog" data-backdrop="static" style="cursor:move">
  <div class="modal-dialog" style="width:410px;">
    ...
    <h2 class="confirm-list">Please Confirm Below Absentees List</h2>
        ...
        <ol class="absenteelist">
          ...
          <button type="button" class="btn btn-success yesConfirm" addedit="add"  data-dismiss="modal">Confirm</button>
