...
<li><i class="fa fa-home"></i> <a href="<?PHP echo base_url('dashboard');?> ">Dashboard </a></li> 
 ...
 <div class="form-group cla mr1">
  ...
  <select class="form-control getstudents"  name="sections" id="sections" addedit="edit"> 
	...
	?>
			...
			if($studentDetails!='0')
			{
				...
				{ if( $prsnt_abs[$cnt]['StudentId'] == $std->StudentId ) { if( $prsnt_abs[$cnt]['PresentAbsent'] =="Present" ) echo 'P'; else echo 'A';  } } else echo 'P'; ?>
                                </p>
  ...
  <div class="modal-dialog" style="width:410px;">
    ...
    <h2 class="confirm-list">Please Confirm Below Absentees List</h2>
        ...
        <li>Venkat</li>
          ...
          <button type="button" class="btn btn-success yesConfirm" addedit="edit" data-dismiss="modal">Confirm</button>
