...
<section id="main-content">
 ...
 <div class="row">
                ...
                <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-laptop"></i> <a href="<?PHP echo base_url('view-sections');?> ">View sections</a> </li>
	...
	<div class="row">
                  ...
                  <div class="col-lg-12">
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                             <?PHP echo @$this->session->flashdata('sectionedited'); ?>
                               <?PHP echo @$this->session->flashdata('failedtoeditSection'); ?>
                              <div class="form col-lg-9">
                                <?PHP
									...
									{
										foreach($sectiondetails->result() as $sectiondet)	
										{
											$ClassName = $sectiondet->ClassSlno;
											$section =  $sectiondet->Section;
										}
									}
				...
				<?PHP foreach($classes->result() as $cls){ ?> <option value="<?PHP echo $cls->SLNO; ?>" <?PHP if($ClassName==$cls->SLNO) { echo 'selected="selected"'; }?> ><?PHP echo $cls->ClassName;?></option><?PHP	} ?>
                                       ...
                                       <div class="form-group ">
                                          ...
                                          <div class="col-lg-6">
										<input  class=" form-control" id="section" name="section" type="text" value="<?PHP echo $section;?>"  />
                                          </div>
                                      ...
                                      <div class="form-group">
                                          <div class="col-lg-offset-4 col-lg-8">
                                             ...
                                             <input type="submit" class="btn btn-primary " name="editSection" value="Update" />
