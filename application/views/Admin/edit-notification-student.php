                                  ...
                                  <form class="form-validate form-horizontal " id="add_notificationstudent_form" method="post" action="">
                                   ...
                                   <div class="form-group notificationdiv">
                                        	 ...
                                        	 <div class="col-lg-6"> 
                                              ...
                                              <input type="text" class="form-control NotificationTitle" name="NotificationTitle" id="NotificationTitle" placeholder="Notification title" value="<?PHP echo $SelectedNotificationTitle; ?>" />
                                              </div>
