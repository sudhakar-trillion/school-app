	...
	<div class="row">
                  ...
                  <div class="col-lg-12">
                      ...
                      <section class="panel">
                          ...
                          <?PHP echo @$this->session->flashdata('fee-added');?>
                                  ...
                                  <form class="form-validate form-horizontal " id="addfeestrucuter" method="post" action="">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="MonthlyFee" id="MonthlyFee" placeholder="Monthly fees" value="<?PHP echo set_value('MonthlyFee')?>" />
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="QuarterlyFee" id="QuaeterlyFee" placeholder="Quarterly Fee"  value="<?PHP echo set_value('QuarterlyFee')?>" />
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="HalfyearlyFee" id="HalfyearlyFee" placeholder="Halfyearly Fee" value="<?PHP echo set_value('HalfyearlyFee')?>" />
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="AnnualFee" id="AnnualFee" placeholder="Annual Fee" value="<?PHP echo set_value('AnnualFee')?>" />
                                      ...
                                      <div class="form-group">
                                          <div class="col-lg-offset-4 col-lg-8">
                                             ...
                                             <input type="submit" class="btn btn-primary " edit_add='add' name="add_fee_structure" id="add_fee_structure" value="Add fee strucutre" />
